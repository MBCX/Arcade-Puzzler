...
loadTimeData.data = {
    ...
    "a11y__how_to_play": `
        To start, press tab and use the arrow keys to move around the grid,
        ...
        all numbers from 1 to 15 have been organised. If you want to go back
        to the main menu, press ESC.
    `,
    "a11y__minutes_passed": "$1 minutes have passed.",
    "a11y__hours_passed": "$1 hours passed.",
    "a11y__button_cant_move": "You can't move this button with id $1.",
